...
Version `0.2.1` is a direct-add-on build:
...
```text
https://kjk-kjkmeg.github.io/thunderbird-sogo-rules/releases/sogo-rules-assistant-0.2.1.xpi
```

Local build path:

```text
/home/morpheus/projects/thunderbird-sogo-rules/dist/sogo-rules-assistant-0.2.1.xpi
```
